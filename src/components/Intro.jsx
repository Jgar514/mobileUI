...
function Intro() {
	return (
		<div className="flex flex-col h-auto bg-izzy-50 z-1 px-2 py-2 border-t-2 border-b-8 border-orange-300 ">
			<div className="bg-transparent flex flex-row gap-5 items-center ">
				...
				<div className="flex flex-column  gap-2">
					...
					<div className="w-2/5 mt-5 bg-transparent py-3 ">
						<a className="bg-izzy-50 text-type border-ol border-2 px-4 py-2 rounded" href="#">
							Resume
						</a>
					</div>
				</div>
			</div>
			<div className="bg-izzy-50  p-2">
